...
VALUES
    (
        "Découvrez la Révolution du Jeu Nomade avec la Console Portable R36S", "decouvrez_la_revolution_du_jeu_nomade_avec_la_console_portable_r36s", "
    ...
    (
        "Plongez dans la Légende avec Final Fantasy VII Rebirth : Une Épopée Redéfinie pour une Nouvelle Génération", "plongez_dans_la_legende_avec_final_fantasy_7_rebirth_une_epopee_redefinie_pour_une_nouvelle_generation", "</h3>
